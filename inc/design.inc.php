...
function getMemberLoginFormCode($sID = 'member_login_form', $sParams = '')
{
    ...
    $oAlert->alert();
    $sFormCode = '<div style="text-align: center; margin-top: 8px;"><a href="modules/?r=facebook_connect/login_form"><img  style="margin-top:-22px;" width="246" border="0" src="' . BX_DOL_URL_ROOT . 'templates/base/images/fbconnectbut.png"></a></div>' . $oForm->getCode();
