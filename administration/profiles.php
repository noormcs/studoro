...
.admin_actions_panel.top-actions {
  position: absolute;
  top: 17px;
  width: 100%;
  z-index: 2147483647;
...
jQuery(document).ready(function(){
	jQuery(".adm-mp-order-item-right select").append("<option value='500'>500</option>");
	jQuery(".adm-mp-order-item-right select").append("<option value='1000'>1000</option>");
	jQuery(".adm-mp-order-item-right select").append("<option value='1500'>1500</option>");
	jQuery(".adm-mp-order-item-right select").append("<option value='2000'>2000</option>");
	jQuery('.adm-mp-qlinks-item').click(function(){
		 jQuery('.adm-mp-qlinks-item').removeClass('active');
