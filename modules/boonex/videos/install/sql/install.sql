...
('[db_prefix]_allowed_exts', 'avi flv mpg wmv mp4 m4v mov divx xvid mpeg 3gp', @iKatID, 'Allowed extensions', 'digit', '', '', 3, ''),
...
('[db_prefix]', '{downloadCpt}', 'download-alt', '{moduleUrl}get_file/{ID}', '', '', 8),
